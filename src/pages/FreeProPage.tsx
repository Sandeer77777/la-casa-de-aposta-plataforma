    ...
    <div className="max-w-[1920px] mx-auto px-4 md:px-10 pt-8 md:pt-16 pb-24 relative z-10">
      ...
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <p className="text-zinc-500 text-base md:text-xl lg:text-2xl max-w-4xl font-medium tracking-wide leading-relaxed px-4">
          Transforme bônus em capital líquido com a precisão de um plano bem traçado. Cada movimento é calculado para maximizar a extração de valor e consolidar o seu saldo.
        </p>
        <div className="flex items-center gap-6 mt-10">
          <div className="h-[2px] w-16 bg-red-500/30" />
          <span className="text-red-500 text-sm font-bold uppercase tracking-[0.4em]">Protocolo Avançado de Conversão</span>
          <div className="h-[2px] w-16 bg-red-500/30" />
        </div>
      </div>
