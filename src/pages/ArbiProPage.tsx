    ...
    <div className="max-w-[1920px] mx-auto px-4 md:px-10 pt-12 md:pt-16 pb-24 relative z-10">
      ...
      <div className="flex flex-col items-center text-center mb-12 md:mb-16">
        ...
        <p className="text-zinc-500 text-sm md:text-lg lg:text-2xl max-w-4xl font-medium tracking-wide leading-relaxed px-4">
          Assim como o Professor, analisamos cada detalhe. Identificamos as melhores brechas no mercado para garantir que cada entrada seja matematicamente perfeita.
        </p>
        <div className="flex items-center gap-4 md:gap-6 mt-8 md:mt-10">
          <div className="h-[1px] w-10 md:w-16 bg-red-500/30" />
          <span className="text-red-500 text-[10px] md:text-sm font-bold uppercase tracking-[0.3em] md:tracking-[0.4em]">Engenharia de Precisão</span>
          <div className="h-[1px] w-10 md:w-16 bg-red-500/30" />
        </div>
      </div>
